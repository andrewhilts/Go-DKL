...
print "<p><a href=\"goal_selection.php?project=".$project[0]."\"><button style=\"cursor:pointer; font-size:1.8em; font-weight:bold; padding:5px;\" class=\"project_name\">".$project[0]."</button></a> \n\t<span class=\"mod_link\"><a href=\"project_management/project_mod.php?project=".$project[0]."\">Modify</a></span>\n";
}
?>
<hr>
<p><a href="project_management/project_create.php" style="text-decoration:none; font-size:1.2em; color:blue;"><button style=" cursor:pointer; font-size:1.2em; color:blue;">New Project</button></a>
</div>
</div>
<?php
}
