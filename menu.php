...
$index_item = menu_item("<img src=\"../house_go.png\" alt=\"home icon\">", "Projects", "index.php", "index");
...
$correlations_item = menu_item("Correlated Goals", "Correlated Goals", "correlations.php?project=".$ActiveProject, null);
$project_model_create_item = menu_item("Project Models", "Project Models", "project_model_create.php?project=".$ActiveProject, null);
...
switch($thisPage){
   ...
   case "project_model.php":
      $project_model_create_item = menu_item("Project Models", "Project Models", "project_model_create.php?project=".$ActiveProject, "parent");
      break;
