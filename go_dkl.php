...
include('shared.php');
$ActiveProject = "Go DKL Sample";
$ActiveProjMod = "Go DKL Sample Data";

include('forms.php');
$ActiveProjModName = "GO DKL Sample Data";
...
<div id="goal_classes">
    	...
    	include('go_dkl_sample_data.php');
    	$ii=0;
    	foreach($go_dkl_sample_data as $slice){
    	   $ii++;
    	    $a_id = $slice["a_id"];
       		$d_id = $slice["d_id"];
	        $lg_id = $slice["lg_id"];
