...
if(isset($_GET['projmod'])){
    ...
    redirect("project_model_create.php?project=".$ActiveProject."&message=nomodelselected");
}
}
...
if((isset($_POST['projmod_name']))&&($_POST['projmod_name']!=="")){
    ...
    redirect("project_model_create.php?project=".$ActiveProject."&message=projmodnameerror");
}
}
